...
function App() {
	return (
		<main className="flex flex-col md:flex-row bg-pink px-7 py-9 bg-[url(/images/bg-intro-mobile.png)] md:bg-[url(/images/bg-intro-desktop.png)] bg-no-repeat bg-cover min-h-screen font-pop text-white max-w-[90rem] mx-auto">
